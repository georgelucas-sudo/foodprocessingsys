            ...
            <div class="row page-titles mx-0">
                <div class="col p-md-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)"> Add Finished Products</a></li>
                    </ol>
                </div>
            </div>
            <!-- row -->
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="card"  style="border-radius:0px;">
                            <div class="card-body" >
							<a class="btn btn-primary" href="manageFinshedProducts.php" style="border-radius:0px;"> MANAGE FINISHED  PRODUCTS</a>
								<div class="form-validation">
									...
									<div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="pname" placeholder="Enter a product name">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-password" name="pprice" placeholder="Enter product price">
                                            </div>
                                        </div>
                                      
                                        <div class="form-group row">
                                            <div class="col-lg-8 ml-auto">
                                                <button type="submit" style="border-radius:0px;" name="addProduct" class="btn btn-primary">Add Product</button>
                                            </div>
                                        </div>
										</form>
										<br>
										<?php
											...
											if(isset($_POST['addProduct']))
											{
												...
												{
													$d = "INSERT INTO `finishedproducts`(pname,pquantity,pprice,addedBy) VALUES('".$pname."','".$pquantity."','".$pprice."','".$uid."')";
													if(mysqli_query($con,$d))
													{
														echo '<center><p class ="text-success">Finished Product added successfully</p></center>';
													}else{
