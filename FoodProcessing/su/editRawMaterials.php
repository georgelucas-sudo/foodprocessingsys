                            ...
                            <div class="card-body">
								...
								<div class="form-validation">
											<?php
												...
												{
													$id  = $_GET['id'];
													$q = "SELECT * FROM `rawmaterials` WHERE `id`='".$id."' ";
									...
									<div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-8 ml-auto">
                                                <button type="submit" style="border-radius:0px;" name="saveProduct" class="btn btn-primary">Update Raw Material</button>
                                            </div>
                                        </div>
										</form>
										...
										<?php
											...
											if(isset($_POST['saveProduct']))
											{
												...
												{
													$d = "UPDATE `rawmaterials` SET `pname`='".$pname."',`pquantity`='".$pquantity."',`pprice`='".$pprice."' WHERE `id`='".$id."' ";
													if(mysqli_query($con,$d))
													{
														echo '<center><p class ="text-success">Raw material updated successfully</p></center>';
													}else{
